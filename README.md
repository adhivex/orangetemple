...
cp .env.example .env.local   # optional in Phases 0–1
corepack pnpm dev
```

Then open http://localhost:3000 and http://localhost:3000/design-system. All commands are listed in `CLAUDE.md`.
